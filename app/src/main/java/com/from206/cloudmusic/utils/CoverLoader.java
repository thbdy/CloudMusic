...
//                bitmap = ImagesUtils.resizeImage(bitmap, ScreenUtils.getScreenWidth() / 2, ScreenUtils.getScreenWidth() / 2);
//                return bitmap;
//            default:
...
//        switch (type) {
//            case BLUR:
//                return ImagesUtils.blur(bitmap);
//            case ROUND:
//                bitmap = ImagesUtils.resizeImage(bitmap, ScreenUtils.getScreenWidth() / 2, ScreenUtils.getScreenWidth() / 2);
//                return ImagesUtils.createCircleImage(bitmap);
//            default:
//                return bitmap;
//        }
//    }
